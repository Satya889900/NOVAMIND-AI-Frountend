...
const MODEL_DISPLAY: Record<string, { label: string; bg: string; border: string; text: string; icon: 'sparkles' | 'zap' | 'bot' | 'image' }> = {
  ...
  'cerebras/llama3.1-8b':                      { label: 'Llama 3.1 8B (Cerebras)',       bg: 'bg-indigo-50 dark:bg-indigo-950/20',  border: 'border-indigo-200/50 dark:border-indigo-800/30',  text: 'text-indigo-600 dark:text-indigo-400',  icon: 'zap' },
  'cerebras/llama-3.3-70b':                    { label: 'Llama 3.3 70B (Cerebras)',      bg: 'bg-violet-50 dark:bg-violet-950/20',  border: 'border-violet-200/50 dark:border-violet-800/30',  text: 'text-violet-600 dark:text-violet-400',  icon: 'zap' },
  'cerebras/llama-4-scout-17b-16e-instruct':   { label: 'Llama 4 Scout 17B (Cerebras)', bg: 'bg-purple-50 dark:bg-purple-950/20',  border: 'border-purple-200/50 dark:border-purple-800/30',  text: 'text-purple-600 dark:text-purple-400',  icon: 'sparkles' },
  'cloudflare/@cf/meta/llama-3.3-70b-instruct-fp8-fast': { label: 'Llama 3.3 70B (CF)', bg: 'bg-orange-50 dark:bg-orange-950/20', border: 'border-orange-200/50 dark:border-orange-800/30', text: 'text-orange-600 dark:text-orange-400', icon: 'zap' },
