...
const MODEL_DISPLAY: Record<string, { label: string; bg: string; border: string; text: string; icon: 'sparkles' | 'zap' | 'bot' | 'image' }> = {
  ...
  'cloudflare/@cf/meta/llama-3.2-3b-instruct':          { label: 'Llama 3.2 3B (CF Fast)', bg: 'bg-amber-50 dark:bg-amber-950/20', border: 'border-amber-200/50 dark:border-amber-800/30', text: 'text-amber-600 dark:text-amber-400', icon: 'zap' },
